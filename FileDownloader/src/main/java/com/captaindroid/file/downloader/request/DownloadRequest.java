...
package com.captaindroid.file.downloader.request;

import com.captaindroid.file.downloader.Error;
import com.captaindroid.file.downloader.OnCancelListener;
import com.captaindroid.file.downloader.OnDownloadListener;
import com.captaindroid.file.downloader.OnPauseListener;
import com.captaindroid.file.downloader.OnProgressListener;
import com.captaindroid.file.downloader.OnStartOrResumeListener;
import com.captaindroid.file.downloader.Priority;
import com.captaindroid.file.downloader.Response;
import com.captaindroid.file.downloader.Status;
import com.captaindroid.file.downloader.core.Core;
import com.captaindroid.file.downloader.internal.ComponentHolder;
import com.captaindroid.file.downloader.internal.DownloadRequestQueue;
import com.captaindroid.file.downloader.internal.SynchronousCall;
import com.captaindroid.file.downloader.utils.Utils;
        ...
        if (status != Status.CANCELLED) {
            ...
            Core.getInstance().getExecutorSupplier().forMainThreadTasks()
                    .execute(new Runnable() {
                        public void run() {
                            if (onDownloadListener != null) {
                                onDownloadListener.onDownloadComplete(fileName, downloadId);
                            }
                            finish();
                        }
                    });
