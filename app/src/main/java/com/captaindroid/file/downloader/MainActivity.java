package com.captaindroid.file.downloader;
...
import com.captaindroid.file.downloader.utils.Utils2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dirPath = Utils2.getRootDirPath(getApplicationContext());
                ...
                downloadIdOne = PRDownloader.download(URL1, dirPath, "facebook.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressOne.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                                progressBarOne.setIndeterminate(false);
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                            public void onDownloadComplete(String fileName, int downloadId) {
                                buttonOne.setEnabled(false);
                                buttonCancelOne.setEnabled(false);
                ...
                downloadIdTwo = PRDownloader.download(URL2, dirPath, "wechat.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressTwo.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdThree = PRDownloader.download(URL3, dirPath, "instagram.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressThree.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdFour = PRDownloader.download(URL4, dirPath, "flashlight.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressFour.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdFive = PRDownloader.download(URL5, dirPath, "screenrecorder.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressFive.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdSix = PRDownloader.download(URL6, dirPath, "callrecorder.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressSix.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdSeven = PRDownloader.download(URL7, dirPath, "soundprofile.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressSeven.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdEight = PRDownloader.download(URL8, dirPath, "evernote.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressEight.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdNine = PRDownloader.download(URL9, dirPath, "ucbrowser.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressNine.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdTen = PRDownloader.download(URL10, dirPath, "barcodescanner.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressTen.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdEleven = PRDownloader.download(URL11, dirPath, "BigBuckBunny.m4v")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressEleven.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdTwelve = PRDownloader.download(URL12, dirPath, "harry-porter.pdf")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressTwelve.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdThirteen = PRDownloader.download(URL13, dirPath, "giphy.gif")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressThirteen.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdFourteen = PRDownloader.download(URL14, dirPath, "small.mp4")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressFourteen.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdFifteen = PRDownloader.download(URL15, dirPath, "big_buck_bunny_720p_10mb.mp4")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressFifteen.setText(Utils2.getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
